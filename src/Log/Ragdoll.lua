...
function Ragdoll.ConfigureRagdollJoints(create, model, rigType)
...
function Ragdoll.RemoveRagdollJoints(model)
...
function Ragdoll.GetMotors(model, rigType)
...
function Ragdoll.DisableParticleEmittersAndFadeOutYielding(character, duration)
...
function Ragdoll.EaseJointFriction(character, duration)
	local descendants = character:GetDescendants()
